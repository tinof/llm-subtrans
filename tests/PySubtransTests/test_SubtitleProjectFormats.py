...
"""
    ...
    def test_ProjectFileRoundtripPreservesHandler(self):
        ...
        self.assertLoggedIsNotNone(
            "reopened project has subtitles", reopened_project.subtitles
        )
...
"""
        ...
        assert line.text is not None
        self.assertLoggedEqual(
            "line text converted to HTML", "<b>Hello</b> World!", line.text
        )
...
"""
        ...
        self.assertLoggedTrue(
            "override tags captured", has_override_tags, input_value=line.metadata
        )
...
"""
        ...
        self.assertLoggedTrue(
            "output file exists", os.path.exists(out_path), input_value=out_path
        )
        ...
        self.assertLoggedEqual(
            "content preserved", 1, converted_project.subtitles.linecount
        )
