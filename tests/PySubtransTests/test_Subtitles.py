...
from PySubtrans.Helpers.SubtitleHelpers import (
    MergeSubtitles,
    MergeTranslations,
    FindSplitPoint,
    GetProportionalDuration,
)
...
class TestSubtitles(LoggedTestCase):
    ...
    example_line_5 = SubtitleLine(
        "5\n00:00:08,000 --> 00:00:09,500\nThis is line 5.\nThis is line 5 continued"
    )
    example_line_11 = SubtitleLine(
        "11\n00:00:10,000 --> 00:00:11,000\nThis is line 11, which is a bit longer!"
    )
    alternative_line_1 = SubtitleLine(
        "1\n00:00:01,000 --> 00:00:02,000\nThis is an alternative line 1"
    )
    alternative_line_2 = SubtitleLine(
    ...
    split_point_cases = [
        (
            "1\n00:00:01,000 --> 00:00:05,000\nThis is a test subtitle, break after comma.",
            "This is a test subtitle,",
        ),
        (
            "2\n00:00:06,000 --> 00:00:10,000\nSecond test subtitle. Break after period.",
            "Second test subtitle.",
        ),
        (
            "3\n00:00:11,000 --> 00:00:15,000\nThird test subtitle! Break after exclamation mark.",
            "Third test subtitle!",
        ),
        (
            "4\n00:00:16,000 --> 00:00:20,000\nFourth test subtitle? Break after question mark.",
            "Fourth test subtitle?",
        ),
        (
            "5\n00:00:21,000 --> 00:00:25,000\nFifth test subtitle... Break after ellipsis.",
            "Fifth test subtitle...",
        ),
        (
        ...
        (
            "12\n00:00:51,000 --> 00:00:55,000\nTwelfth test subtitle.    Break after three spaces.",
            "Twelfth test subtitle.",
        ),
        (
        ...
        (
            '15\n00:01:06,000 --> 00:01:10,000\nThey say, "We should not! Split a quotation!"',
            "They say,",
        ),
        (
    ...
    def test_FindSplitPoint(self):
        ...
        for source, first_part in self.split_point_cases:
            with self.subTest(source=source):
                ...
                break_point = FindSplitPoint(
                    line, split_patterns, min_duration, min_split_chars
                )
                result = line.text[:break_point].strip()
                self.assertLoggedEqual(
                    "split point text", first_part, result, input_value=line
                )
    ...
    proportional_duration_cases = [
        ...
        (
            ...
            timedelta(seconds=1.0, microseconds=571429),
        ),
        (
            example_line_3,
            14,
            timedelta(seconds=0.75),
            timedelta(seconds=2.0, microseconds=200000),
        ),
    ...
    def test_GetProportionalDuration(self):
        for (
            ...
            min_duration,
            expected_duration,
        ) in self.proportional_duration_cases:
            with self.subTest(line=line, characters=characters):
                result = GetProportionalDuration(
                    line, characters, min_duration=min_duration
                )
                self.assertLoggedEqual(
